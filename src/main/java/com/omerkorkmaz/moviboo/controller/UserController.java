...
import com.omerkorkmaz.moviboo.validators.UserValidator;
...
public class UserController extends AdminBaseController
{
	...
	public String createUser(@Valid @ModelAttribute("user") User user, BindingResult result, 
		...
		logger.debug("Created new User with id : {} and name : {}", persistedUser.getUserId(), persistedUser.getEmail());
	...
	public String updateUser(@ModelAttribute("user") User user, BindingResult result, 
		...
		logger.debug("Updated user with id : {} and name : {}", persistedUser.getUserId(), persistedUser.getEmail());
